...
const customTooltips = function (e) {
    ...
    t || ((t = document.createElement("div")), (t.id = "chartjs-tooltip"), (t.className = "chartjs-tooltip"), (t.innerHTML = "<table></table>"), document.body.appendChild(t));
    const a = e.tooltip;
    if (0 === a.opacity) return void (t.style.opacity = 0);
    if ((t.classList.remove("above", "below", "no-transform"), a.yAlign ? t.classList.add(a.yAlign) : t.classList.add("no-transform"), a.body)) {
        const e = a.title || [],
            r = a.body.map(function (e) {
                return e.lines;
            });
        let o = "<thead>";
    ...
    const r = document.querySelector(".chartjs-tooltip"),
        ...
        n = r.clientHeight,
        i = document.querySelector('html[dir="rtl"]');
    (t.style.opacity = 1),
        (t.style.position = "absolute"),
        (t.style.left = o.left + window.pageXOffset + a.caretX - (null !== i ? r.clientWidth : 0) + "px"),
        (t.style.top = o.top + window.pageYOffset + a.caretY - (a.caretY > 10 ? (n > 100 ? n + 5 : n + 15) : 70) + "px"),
        (t.style.padding = a.padding + "px " + a.padding + "px"),
        (t.style.pointerEvents = "none");
},
    chartLinearGradient = (e, t, a) => {
        const r = e.getContext("2d").createLinearGradient(0, 0, 0, t);
        return r.addColorStop(0, "" + a.start), r.addColorStop(1, "" + a.end), r;
    };
function chartjsAreaChart(e, t, a, r) {
    let o;
    const n = {
        id: "legendMargin",
        beforeInit(e, t, a) {
    ...
    if (i) {
        i.getContext("2d"), (i.height = window.innerWidth <= 575 ? 180 : t);
        new Chart(i, {
            type: "line",
            data: {
            ...
            options: {
                    ...
                    tooltip: {
                        ...
                        callbacks: {
                            label: function (e) {
                                ...
                                return t && (t += ": "), null !== e.parsed.y && (t += new Intl.NumberFormat().format(e.parsed.y)), `<span class="data-label">${t}K</span>`;
                            },
                        },
                    },
                },
                animation: {
                    ...
                    delay: (e) => {
                        let t = 0;
                        return "data" !== e.type || "default" !== e.mode || o || (t = 200 * e.dataIndex + 50 * e.datasetIndex), t;
                    },
                },
                ...
                scales: {
                    y: {
                        ...
                        ticks: { beginAtZero: !0, font: { size: 14, family: "'Jost', sans-serif" }, color: "#747474", padding: 15, max: 80, min: 0, stepSize: 20, callback: (e, t, a) => e + "K" },
                    },
                    x: {
...
function chartjsBarChart(e, t, a, r, o, n, i) {
    let l;
    ...
    if (d) {
        ...
        new Chart(d, {
            ...
            data: {
                labels: r,
                datasets: [
                    { data: t, backgroundColor: "rgba(130, 49, 211, .50)", hoverBackgroundColor: "#7811FF", label: n, barPercentage: 0.45, borderRadius: 2, maxBarThickness: 11, minBarLength: 2, barThickness: 15 },
                    { data: a, backgroundColor: "rgba(0, 170, 255, .50)", hoverBackgroundColor: "#00AAFF", label: i, barPercentage: 0.45, borderRadius: 2, maxBarThickness: 11, minBarLength: 2, barThickness: 15 },
                ],
            },
            options: {
                maintainAspectRatio: !0,
                ...
                animation: {
                    ...
                    delay: (e) => {
                        let t = 0;
                        return "data" !== e.type || "default" !== e.mode || l || (t = 200 * e.dataIndex + 50 * e.datasetIndex), t;
                    },
                },
                layout: { padding: { left: -13, right: -10, top: 0, bottom: 0 } },
                elements: { point: { radius: 0 } },
...
function chartjsLineChart(e, t, a, r, o, n) {
    let i, l, d;
    (d = getComputedStyle(document.documentElement).getPropertyValue("--color-primary")), (l = getComputedStyle(document.documentElement).getPropertyValue("--color-primary-rgba"));
    var s = document.getElementById(e);
    if (s) {
        s.getContext("2d"), (s.height = window.innerWidth <= 1399 ? (window.innerWidth < 575 ? 200 : 150) : t);
        new Chart(s, {
            type: "line",
            data: {
                labels: r,
                datasets: [
                    {
                        ...
                        borderColor: d,
                        borderWidth: 3,
                        backgroundColor: () => chartLinearGradient(document.getElementById(e), 300, { start: `rgba(${l},0.5)`, end: "rgba(255,255,255,0.05)" }),
                        fill: n,
                        label: o,
                        tension: 0.4,
                        hoverRadius: "6",
            ...
            options: {
                ...
                animation: {
                    ...
                    delay: (e) => {
                        let t = 0;
                        return "data" !== e.type || "default" !== e.mode || i || (t = 200 * e.dataIndex + 50 * e.datasetIndex), t;
                    },
                },
                layout: { padding: { left: -13, right: -10, top: 0, bottom: 0 } },
                elements: { point: { radius: 0 } },
...
function exampleBarChart(e, t, a) {
    let r;
    var o = document.getElementById(e);
    if (o) {
        o.getContext("2d"), (o.height = window.innerWidth <= 575 ? 180 : t);
        new Chart(o, {
            type: "bar",
            data: {
            ...
            options: {
                ...
                animation: {
                    ...
                    delay: (e) => {
                        let t = 0;
                        return "data" !== e.type || "default" !== e.mode || r || (t = 200 * e.dataIndex + 50 * e.datasetIndex), t;
                    },
                },
            },
        });
...
function exampleBarStackedChart(e, t, a) {
    let r;
    var o = document.getElementById(e);
    if (o) {
        o.getContext("2d"), (o.height = window.innerWidth <= 575 ? 180 : t);
...
function exampleLineChart(e, t, a) {
    let r;
    var o = document.getElementById(e);
    if (o) {
        o.getContext("2d"), (o.height = window.innerWidth <= 575 ? 180 : t);
...
function exampleAreaChart(e, t, a, r, o, n) {
    let i, l, d;
    (d = getComputedStyle(document.documentElement).getPropertyValue("--color-primary")), (l = getComputedStyle(document.documentElement).getPropertyValue("--color-primary-rgba"));
    var s = document.getElementById(e);
    if (s) {
        s.getContext("2d"), (s.height = window.innerWidth <= 575 ? 180 : t);
        new Chart(s, {
            type: "line",
            data: {
                labels: r,
...
function exampleRadarChart(e, t) {
    let a;
    var r = document.getElementById(e);
    if (r) {
        r.getContext("2d"), (r.height = window.innerWidth <= 575 ? 180 : t);
        new Chart(r, {
            type: "radar",
            data: {
            ...
            options: {
                ...
                animation: {
                    ...
                    delay: (e) => {
                        let t = 0;
                        return "data" !== e.type || "default" !== e.mode || a || (t = 200 * e.dataIndex + 50 * e.datasetIndex), t;
                    },
                },
                elements: { point: { radius: 0 } },
            },
...
!(function (e) {
    ...
    var a = {
        ...
        r = { dots: !1, slidesToShow: 1, slidesToScroll: 1, fade: !0, infinite: !0, asNavFor: ".testimonial-slider3-nav", arrows: !1 },
        n = {
            dots: !1,
            infinite: !0,
            slidesToShow: 3,
    ...
    "rtl" == e("html").attr("dir") && ((a.rtl = !0), (l.rtl = !0), (o.rtl = !0), (r.rtl = !0), (n.rtl = !0), (d.rtl = !0)),
        e(".banner-slider").slick(a),
        e(".testimonial-slider1").slick(l),
        e(".testimonial-slider2").slick(o),
        e(".testimonial-slider3-for").slick(r),
        e(".testimonial-slider3-nav").slick(n),
            ...
            function () {
                if (window.File && window.FileList && window.FileReader) {
                    ...
                    for (let e = 0; e < t.length; e++) {
                        let a = t[e];
                        if (!a.type.match("document")) continue;
    ...
    let f = function (t, s) {
        var a = s.value || 20,
            l = s.handle || e(".ui-slider-handle"),
            i = `<span class="tooltip-text">${a}</span>`;
        e(l).html(i);
    };
    ...
    w && w.forEach((e) => e.addEventListener("click", T)), y && y.addEventListener("click", x), C && C.forEach((e) => e.addEventListener("click", x)), L && L.addEventListener("click", x);
    ...
    q &&
        ...
        e("#select-tag1").select2({ placeholder: "Select candidate", dropdownCssClass: "tag", allowClear: !0 }),
        e("#select-tag2").select2({ placeholder: "Select program", dropdownCssClass: "tag", allowClear: !0 }),
        e("#select-tag3").select2({ placeholder: "Select 3 primary skills", dropdownCssClass: "tag", allowClear: !0 }),
        e("#select-tag4").select2({ placeholder: "Select 3 secondary skills", dropdownCssClass: "tag", allowClear: !0 }),
        e("#select-tag5").select2({ placeholder: "Select mielstone skill", dropdownCssClass: "tag", allowClear: !0 }),
    ...
    const I = document.querySelector(".btn-compose"),
        ...
        j = document.querySelector(".add-lebel-from"),
        W = document.querySelector(".compose-close"),
        H = document.querySelector(".label-close");
    function Q(t) {
        t.preventDefault(), "label" == this.dataset.trigger ? j.classList.add("show") : "compose" == this.dataset.trigger && $.classList.add("show"), e(t.target).hasClass("label-close") && j.classList.remove("show");
    }
    function U(e) {
        e.preventDefault(), "label" == this.dataset.trigger ? j.classList.remove("show") : "compose" == this.dataset.trigger && $.classList.remove("show");
    }
    null !== I && null !== W && (I.addEventListener("click", Q), P.addEventListener("click", Q)), null !== W && null !== H && (W.addEventListener("click", U), H.addEventListener("click", U));
    ...
    function te(t, s, a) {
        var l, i;
        try {
            (i = e.datepicker.parseDate(a, t)), e.datepicker.parseDate(a, s) < i && ((l = t), (t = s), (s = l));
        } catch (e) { }
    ...
    J &&
        ...
        (e.fn.dateRangePicker = function (t) {
            ...
            function n(a, l) {
                var i, o;
                (a = a.split(t.rangeSeparator)).length > 0 ? ((i = e.datepicker.parseDate(l, a[0])), a.length > 1 && (o = e.datepicker.parseDate(l, a[1])), (s = { start: i, end: o })) : (s = null);
            }
            return (
                (t.beforeShow = function (t, s) {
                    var l = a.datepicker("option", "dateFormat");
                    n(e(t).val(), l), o.apply(a, arguments);
                }),
                (t.beforeShowDay = function (e) {
                    var t,
                        l = [!0, ""];
                    return s && s.start <= e && s.end && e <= s.end && (l[1] = "ui-datepicker-range"), r && ((t = r.apply(a, arguments)), (l[0] = l[0] && t[0]), (l[1] = l[1] + " " + t[1]), (l[2] = t[2])), l;
                }),
                (t.onSelect = function (s, i) {
                    var o;
                    if (i.rangeStart) {
                        if (((i.inline = !1), (o = i.rangeStart) !== s)) {
                            var r = a.datepicker("option", "dateFormat"),
                                n = te(o, s, r);
                            if ((a.val(n.start + t.rangeSeparator + n.end), (i.rangeStart = null), t.useHiddenAltFields)) {
                                var d = a.attr("data-to-field"),
                                    c = a.attr("data-from-field");
                                e("#" + c).val(n.start), e("#" + d).val(n.end);
                            }
                        }
                    } else (i.inline = !0), (i.rangeStart = s);
                    l.apply(a, arguments);
                }),
                (t.onClose = function (e, t) {
                    (t.rangeStart = null), (t.inline = !1), i.apply(a, arguments);
                }),
                this.each(function () {
