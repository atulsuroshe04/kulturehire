...
router.post("/programs/save/:language(en|gr|ar)", ProgramController.programSave);
router.post("/programs/update/:id/:language(en|gr|ar)", ProgramController.programUpdate);
...
router.post(
  ...
  [localeMiddleware.localized, authMiddleware.isAuthenticated, uploadSimulationAttchmentMiddleware.uploadFiles],
